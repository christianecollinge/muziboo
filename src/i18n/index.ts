...
<<<<<<< HEAD
    line1: "Echte Musik.",
    line2: "Echte Menschen.",
    notPlatform: "Keine Streaming-Plattform.",
    notTalent: "Keine Casting-Show.",
    workshop: "Eine Werkstatt.",
    description:
      "Muziboo ist ein Raum für Hobbymusiker, Bedroom-Producer und alle, die Musik mit den eigenen Händen machen.",
    share: "Teile deinen Sound mit Menschen, denen Handwerk wichtig ist — nicht Kennzahlen.",
  },
  features: {
    title: "Eine Werkstatt, keine Bühne.",
=======
    line1: "Real Music.",
    line2: "Real People.",
...
>>>>>>> b1623401 (feat: init muziboo site with signup and posthog)
    items: [
      ...
      },
      {
        title: "Mensch zuerst",
<<<<<<< HEAD
        body: "Jeder Track hier beginnt mit einer Person. Nicht, weil wir Technik ablehnen — sondern weil wir glauben, dass Musik mit Absicht beginnt.",
      },
      {
        title: "Work in Progress",
        body: "Musik kommt nicht fertig an. Wir bauen Tools, mit denen du zeigen kannst, wie ein Song entsteht — vom ersten Take zum finalen Mix.",
      },
      {
        title: "Echtes Entdecken",
        body: "Fokussierte Entdeckung. Transparente Timelines. Keine Ranking-Spiele. Keine unsichtbaren Systeme, die entscheiden, wer gehört wird.",
      },
      {
        title: "Feedback-Threads",
        body: "Echte Gespräche über die Arbeit. Konstruktiv, öffentlich, im Zuhören verwurzelt — nicht in Likes und Followern.",
      },
      {
        title: "Dein Raum",
        body: "Baue deinen Katalog. Erzähle deine Geschichte. Ein Profil, das deinen Weg spiegelt — keine Engagement-Strategie.",
=======
...
>>>>>>> b1623401 (feat: init muziboo site with signup and posthog)
  ...
  manifesto: {
    ...
    paragraphs: [
<<<<<<< HEAD
      "Das Internet wurde nicht für Perfektion gebaut. Es wurde für Teilhabe gebaut.",
      "Bevor Streams gezählt und Feeds gerankt wurden, teilten Menschen, woran sie arbeiteten. Demos. Fragmente. Aufnahmen mitten in der Nacht. Unfertige Songs.",
      "Musik war Gespräch.",
      "Muziboo ist ein Zuhause für dieses Gespräch.",
      "Wir glauben: Musik ist kein Content. Sie ist Handwerk.",
      "Sie ist der Klang von jemandem, der es versucht. Lernt. Sich verbessert. Sich verbindet.",
      "Wir sind nicht für Viralität da. Nicht für Kennzahlen. Nicht für Abkürzungen.",
      "Wir sind da für Musiker, die Musik machen, weil sie müssen.",
      "Bedroom-Producer. Garage-Bands. Chorsänger. Gitarristen, die letzten Monat angefangen haben. Schlagzeuger, die seit dreißig Jahren spielen.",
      "Jede Note hier wurde von jemandem gespielt, dem es wichtig genug war, es zu versuchen.",
      "Keine Ranking-Spiele. Keine künstliche Verstärkung. Keine unsichtbaren Systeme.",
      "Chronologisch. Transparent. Menschlich.",
      "Muziboo ist keine Bühne.",
      "Es ist eine Werkstatt. Ein Probenraum. Ein Gemeindesaal. Ein Ort, an dem Unfertiges willkommen ist.",
      "Weil Musik nicht poliert beginnt.",
      "Sie beginnt mit Menschen.",
      "Und Menschen reichen.",
    ],
  },
=======
...
<<<<<<< HEAD
        body: "La música no llega terminada. Estamos construyendo herramientas para mostrar cómo evoluciona una canción — del primer take al mix final.",
      },
      {
        title: "Descubre de verdad",
        body: "Descubrimiento enfocado. Líneas de tiempo transparentes. Sin juegos de ranking. Sin sistemas invisibles que deciden a quién se escucha.",
      },
      {
        title: "Hilos de feedback",
=======
...
>>>>>>> b1623401 (feat: init muziboo site with signup and posthog)
      ...
      },
      {
        title: "Tu espacio",
<<<<<<< HEAD
        body: "Construye tu catálogo. Cuenta tu historia. Un perfil que refleje tu camino — no una estrategia de engagement.",
=======
