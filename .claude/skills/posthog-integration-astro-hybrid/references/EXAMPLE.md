	...
	<div class="container">
		...
		<div style="text-align: center;">
			...
			<p id="success-message" class="success" style="display: none;">
				Thank you for your consideration! Count: <span id="consideration-count"
				></span>
			</p>
		</div>
...
<script is:inline>
	...
	document.addEventListener("DOMContentLoaded", () => {
		...
		updateStats();
		document
			.getElementById("consider-btn")
			?.addEventListener("click", handleConsideration);
	});
</script>
```
...
<PostHogLayout title="Home - Astro PostHog Hybrid Example">
	<div class="container">
		...
		<div id="logged-out-view">
			...
			<p class="note">
				Note: This is a demo app with server-side tracking. Use any username and
				password to sign in.
			</p>
		</div>
	</div>
	...
	<div class="container">
		...
		<div class="stats">
			...
			<p>
				...
				<span id="profile-considerations">0</span>
			</p>
		</div>
...
<script is:inline>
	...
	function updateProfile() {
		...
		document.getElementById("profile-considerations").textContent =
			considerations;
	...
	document.addEventListener("DOMContentLoaded", () => {
		...
		document
			...
			?.addEventListener("click", triggerTestError);
	});
</script>
```
